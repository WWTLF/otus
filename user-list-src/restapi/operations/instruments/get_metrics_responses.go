...
type GetMetricsOK struct {
	...
	/*
	  In: Body
	*/
	Payload models.Any `json:"body,omitempty"`
}
...
func (o *GetMetricsOK) WithPayload(payload models.Any) *GetMetricsOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get metrics o k response
func (o *GetMetricsOK) SetPayload(payload models.Any) {
	o.Payload = payload
}
